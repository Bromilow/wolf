...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/11/24 09:15:04 by rbromilo          #+#    #+#             */
/*   Updated: 2016/11/24 09:15:05 by rbromilo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	*my_recognise_arg(char c, va_list ap)
{
	...
	if (c == 'p')
		return (ft_strjoin("0x",ft_uitoa_base((uintptr_t)va_arg(ap,void*),16)));
		return (NULL);
}
...
int		ft_printf(const char *format, ...) // |p|
{
	va_list ap;
	char	*out;
	char	*temp;
